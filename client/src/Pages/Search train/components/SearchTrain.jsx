...
//   const [arrivalStation, setArrivalStation] = useState('');
//   const [selectedDate, setSelectedDate] = useState('');
//   const [stations, setStations] = useState({ departureStations: [], arrivalStations: [] });
...
//   const handleSearch = async () => {
//     try {
//       const response = await axiosInstance.get('/trains/get/search', {
//         params: {
//           departureStation: departureStation,
//           arrivalStation: arrivalStation,
//           selectedDate: selectedDate,
...
//   const fetchStations = async () => {
//     try {
//       const response = await axiosInstance.get('/trains/get/stations'); // Adjust the endpoint according to your backend API
//       const stationsData = response.data;
//       setStations(stationsData); // Set the list of stations in the state
//     } catch (error) {
//       console.error('Error fetching stations:', error);
